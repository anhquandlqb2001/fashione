...
class NotificationViewModel @Inject constructor(private val notificationRepositoryFirestore: NotificationRepository) :
    ...
    private val _notificationType: MutableLiveData<Resource<List<NotificationType>>> by lazy {
        val liveData = MutableLiveData<Resource<List<NotificationType>>>()
    ...
    val notificationType: LiveData<Resource<List<NotificationType>>> get() = _notificationType
}